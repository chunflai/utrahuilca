        ...
        <div class="col-12 d-flex justify-content-between">
          ...
          <div class="top-contact-info d-flex align-items-center">
           ...
           <a href="https://www.youtube.com/channel/UCZa_TvUo3FlzVz-jnn_67jw"><i class="fa fa-youtube" aria-hidden="true"></i>  </a>
                      ...
                      <div id="contenido11">
                        ...
                        <div class="tab-content" id="nav-tabContent">
                          <div class="tab-pane fade show active" id="nav-home1" role="tabpanel" aria-labelledby="nav-home-tab">
                            ...
                            <div class="col text-center mt-5">
                              <button class="btn btn-lg text-white w-50"  role="link" onclick="window.location=''" style="background: #eb9008">Registrarse</button>
                            </div>
                          </div>
                          <div class="tab-pane fade" id="nav-profile1" role="tabpanel" aria-labelledby="nav-profile-tab">
                            ...
                            <div class="col text-center mt-5">
                              <button class="btn btn-lg text-white w-50" role="link" onclick="window.location=''" style="background: #eb9008">Ingresar</button>
                              <p class="font-weight-bold"> <a href="#Recomendaciones" data-toggle="modal" >Ver recomendaciones de seguridad </a></p>
                            </div>
                          </div>
                        </div>
              ...
              <!-- Modal -->
              <div class="modal fade bd-example-modal-lg" tabindex="-1" id="UtraPortaljurídica" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                  <div class="modal-header bg-white font-weight-bold" style="width: 165px; height:55px">
                    <b>Soy Asociado <br>
                    Persona Jurídica</b>
                      ...
                      <div id="contenido11">
                        <nav>
                          <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist" style="background: #1f8a32">
                            ...
                            <a class="nav-item nav-link" id="nav-profile-tab2" data-toggle="tab" role="link" onclick="window.location=''" role="tab" aria-controls="nav-profile" aria-selected="false"><b style="font-size: 25px; color: white">Usuario <br>Registrado</b></a>
                          </div>
                        </nav>
                        <div class="tab-content" id="nav-tabContent">
                          <div class="tab-pane fade show active" id="nav-home2" role="tabpanel" aria-labelledby="nav-home-tab">
                            <p class="text-dark mt-3 ml-5 mr-5 text-justify" style="font-size: 25px">
                             - Registre su empresa.
                             <br>
                             - Imprima y firme el formato por el representante legal.
                             <br>
                             - Visite la agencia más cercana para su activación.
                           </p>
                           <div class="col text-center mt-5">
                            <button class="btn btn-lg text-white w-50"  href="#modalLRForm1" style="background: #eb9008" >Registrarse</button>
                          </div>
                        </div>
                    ...
                    <div class="col-12 col-md-10 col-lg-8">
                      <div class="contact-form">
                        ...
                        while ($mostrar=mysqli_fetch_array($result)) { 
                          ...
                          echo "<script>alert('El asociado/a no se encuentra registrado/a por no cumplir con el reglamento del sorteo. Consulte en nuestra página web o su agencia más cercana los parámetros para participar del Plan de Estímulos UTRAHUILCA Ahorrando Voy Ganando. ¡Aún está a tiempo para disfrutar de los beneficios que trae la Cooperativa UTRAHUILCA!');location.href ='javascript:history.back()';</script>";    
                        }  
                      }
                      ?> 
                    </div>
