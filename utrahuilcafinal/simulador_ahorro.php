...
<form action="" id="simulcred">
    <div class="fila1">
        ...
        <input id="monto" ng-trim="true" onkeypress="return validarEspacios(event)" maxlength="14" required="" class="form-control input-sm monto-sol ng-pristine ng-untouched ng-empty ng-invalid ng-invalid-required ng-valid-maxlength" placeholder="Valor depositado">
       
		</div>
        <div class="plazos">
		<label for="destino">Dias*:</label>
        <input id="plazo" ng-trim="true" onkeypress="return validarEspacios(event)" maxlength="4" required="" class="form-control input-sm monto-sol ng-pristine ng-untouched ng-empty ng-invalid ng-invalid-required ng-valid-maxlength" placeholder="Plazo en dias"> 
       </div>
