              ...
              <section class="cta-area d-flex flex-wrap">
                ...
                <div class="cta-content">
                  ...
                  <div class="section-heading white">
                    ...
                    <h2>Personas <?php 
					$tipoin=$_GET['tipo'];
					if ($tipoin=='N') echo 'Naturales';if ($tipoin=='J') echo 'Juridicas o Empresas'?> </h2>
					<?php
					  if ($_GET['tabPag'])
...
<h1 class="tit_ayc"><?php  echo $mostrar['nombre'];?> </h1>
  ...
  $plazo=$mostrar['plazo_meses'];
                ...
                <div class="cta-thumbnail bg-img jarallax" style="background-image: url(<?php if ($tipoin=='N') echo 'img/bg-img/5.jpg';if ($tipoin=='J') echo 'img/Empresa-utrahuilca.png'?> );"></div>    
              </section>
...
<li class="nav-item itemcred">
    <a class="nav-link" href="ahorro.php?tabPag=<?php  echo $mostrar['codigo']."&tipo=".$tipoin;?>" role="tab" aria-controls="home" id="scroll"><img src="images/<?php  echo $mostrar['imagen'];?>" style="width: 50px"><br><?php  echo $mostrar['nombre'];?></a>
  </li>
  <?php }  ?>
</ul>
</div>
