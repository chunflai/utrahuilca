 ...
 <!-- Modal -->
						...
						<div class="modal fade bd-example-modal-lg" tabindex="-1" id="Recomendaciones" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
							...
							<section class="cta-area d-flex flex-wrap">
								...
								<div class="cta-content">
									...
									<div class="section-heading white">
										<div class="line"></div>
										<p>Institucional</p>
										<h2>Documentos UTRAHUILCA </h2>
									</div>
									<h6>Consulte aquí la información enviada por UTRAHUILCA a la DIAN, para los Comentarios de la Sociedad Civil sobre la gestión realizada por la Cooperativa en el año gravable 2018,  con motivo del proceso de actualización del Registro Web en dicha entidad de fiscalización</h6>
								</div>
								<!-- Cta Thumbnail -->
							...
							<section class="services-area section-padding-100-0">
								...
								<!--Fin-Contenido-->
								<p style="text-align: justify;">Esta información fue publicada el 3 de abril de 2019 y estará vigente hasta el 15 de abril de 2019 a las 6 PM</p>
...
<div class="copywrite-area">
	...
	<script type="text/javascript" src="scripts/formatos1.js"></script>
