...
<body>
  ...
  <div id="fondo-modal">
   ...
   <?php include 'menu.php';?>
    ...
    $sql="SELECT * FROM trabaje WHERE idtrabaje=".$_GET['id'];
    ...
    if ($mostrar=mysqli_fetch_array($result)) {
      ?>
						...
						<div class="container">
							<div class="col-12">
								...
								<div class="col-12 mb-10">
									<h2> Se requiere <?php echo $mostrar['titulo']?> que cumpla con el siguiente perfil:<h2>
								</div>
            ...
            <a href="trabajo.php" class="btn credit-btn box-shadow">Ver más vacantes</a>
          </div>
                </div>
	<?php }?>
