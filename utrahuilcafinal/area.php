                    ...
                    <div class="panel-body" style="height: 400px;" id="formularioregistros">
                        ...
                        <form name="formulario" id="formulario" method="POST">
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <input type="text" class="form-control" name="nombreArea" id="nombreArea" maxlength="60" placeholder="nombreArea" required>
                          </div>
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <label>Insertar Codigo</label>
                            <input type="text" class="form-control" name="codigoUsuario" id="codigoUsuario" maxlength="10" placeholder="CodigoArea" required>
                          </div>
