              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">formatoss <button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Agregar</button></h1>
                   ...
                   <div class="panel-body"  id="formularioregistros">
                        ...
                        <textarea id="descripccion" name="descripccion" class="form-control"  required> </textarea> 
                       </div>
                           ...
                           <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-6" >
                            ...
                            <label>Fecha Publicacion(*):</label>
                             <input type="hidden" name="idformatos" id="idformatos">
...
require 'footer.php';
?>
<script type="text/javascript" src="scripts/formatos.js"></script>
<?php 
}
ob_end_flush();
 ?>
