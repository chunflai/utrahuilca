              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Eventos Cooperativos <button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Agregar</button></h1>
                    ...
                    <div class="panel-body"  id="formularioregistros">
                        ...
                        <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                         ...
                         <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <label>link(*):</label>
                            <input type="text" class="form-control" name="link" id= "link" maxlength="500" placeholder="link" >
                          </div>
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <label>Zona(*):</label>
                            <input type="text" class="form-control" name="zona" id= "zona" maxlength="100" placeholder="zona" >
                          </div>
